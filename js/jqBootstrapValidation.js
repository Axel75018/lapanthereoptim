        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Cette adresse mail est incorrecte<!-- data-validator-validemail-message to override -->";
      ...
      ajax: {
		...
		builtInValidators: {
			...
			required: {
				name: "Required",
				type: "required",
				message: "Veuillez renseigner ce champ<!-- data-validator-required-message to override -->"
			},
			checkone: {
				name: "Checkone",
				type: "minchecked",
